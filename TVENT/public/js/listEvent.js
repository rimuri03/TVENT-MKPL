...
function searchEvent() {
  ...
  var eventCards = document.querySelectorAll("#cardRow .card");

  eventCards.forEach(function (card) {
    var eventName = card.querySelector(".card-title").innerText.toLowerCase();
    var eventDescription = card
      .querySelector(".desCard")
      .innerText.toLowerCase();

    if (
      eventName.includes(searchInput) ||
      eventDescription.includes(searchInput)
    ) {
